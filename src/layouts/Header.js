...
export default function Header() {
  ...
  for(let site of Object.keys(sites)){
    ...
    list.push(
      <li key={route}>
        <a className="hover:bg-gray-600 py-2 px-10 rounded-xl text-2xl" href={route}>{site}</a>
      </li>
    );
  }
    ...
    <>
      ...
      <section className='lg:w-1/2 pl-8 flex-col items-center justify-center flex gap-4  mb-10'>
        ...
        <div className="w-full relative p-4">
            ...
            <input type="text" id="voice-search" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
